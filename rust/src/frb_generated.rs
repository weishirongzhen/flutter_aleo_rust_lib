...
fn wire_transfer_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_transfer_type = <String>::sse_decode(&mut deserializer);
            let api_amount = <f64>::sse_decode(&mut deserializer);
            let api_fee = <f64>::sse_decode(&mut deserializer);
            let api_private_fee = <bool>::sse_decode(&mut deserializer);
            let api_private_key = <String>::sse_decode(&mut deserializer);
            let api_amount_record = <Option<String>>::sse_decode(&mut deserializer);
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire_private_key_from_seed_impl(port, ptr, rust_vec_len, data_len),
        3 => wire_to_address_impl(port, ptr, rust_vec_len, data_len),
        2 => wire_to_view_key_impl(port, ptr, rust_vec_len, data_len),
